...
if(isset($_REQUEST['resident_count'])){
    $header_title = "Edited Program Members";
    ...
    if($success){
        ...
        $header_title = "Member(s) Successfully Edited";
    }else{
        // print"<div id='head'><h4>Member(s) Successfully Deleted</h4></div>";
        $header_title = "Member(s) Successfully Edited";
    }
    ...
    $header_title = "Update Program Members";
    ...
    print"<h2 class='m-3 p-2 footer_div' align='center'>$header_title</h2>";
        ...
        <form   name='form'
                ...
                action="ABAIT_updateMembers_v2.php" 
                method="post">
        <?
