...
?>
		...
		<h3 class='m-3 p-2 footer_div' align='center'>Adding User Data</h3>	
<?
			...
			if($action=="Update" or !$row1=mysqli_fetch_assoc($session1)){
					...
					*/
					...
					if($action=='Enroll'){
						...
						print "<h4 align='center'><a href='ABAIT_updateMembers_v2.php'>Return to Update Members Form</a></h4>\n";	
					}
