...
function reload(form, id, population){
    ...
    self.location='ABAIT_create_map_v2.php?'+ id +'='+ checkedValue + '&Population='+ population + location_vars;
...
<style>
	...
	.custom-checkbox-label-add {
		color: green;
	}
	.custom-checkbox-label-remove {
		color: red;
	}
	.text-input-color {
...
print "<h2 class='m-3 p-2 footer_div' align='center'>$behavior $behavior_spelling Episodes for $first $last</h2>";
...
$r=0;
		print "<table align='center'>";//table for more info copy this line
				...
				if($data){
                        ...
                        print "<thead>";
                            print"<tr>";
                                print"<th>";
                                    ...
                                    print"<span class='tab wide'>$behavior_spelling Description</span>";
                                ...
                                print"<tr style='color:$col'>";
                                    print"<td>";
                                        print "<label>";
                                            ...
                                            print"<span class='tab vnarrow'><input class='space10' type='checkbox' name='scales_created[]' id='$un_map[mapkey]' value='$un_map[mapkey]' " .(($un_map['scale_created']) ? " checked='checked'" : "") . "></span>";
                                         
                                            print"<span onClick='verifyDelete(\"$delete_id\")' class='tab narrow'><input class='space10' type='checkbox' name='delete_obs[]' id='$delete_id' value='$un_map[mapkey]'></span>";
                                        print"</label>";
                                    print"</td>";
                                print"</tr>";
                            }
					...
					print "<tr><td><h4>No $behavior_spelling Data of the type: $behavior has been recorded</h4></td></tr>\n";
				}
		...
		print "<table class='table-responsive p-2 m-auto' align='center' border=0>";
...
<br></br>
<div id='submit'>
			<? print "<input 	type = 'submit' name = 'submit' value = 'Submit $behavior_spelling Scale'/>"; ?>
</div>
</form>		
