...
if(isset($_REQUEST['resident_count'])){
	$resident_count = $_REQUEST['resident_count'];
	$header_title = "Program Members Deleted.";
	print"<h2 class='m-3 p-2 footer_div' align='center'>$header_title</h2>";
	...
	if($success){
		$header_title = "Member(s) Successfully Removed from ABAIT";
		print "<h4 align='center'><a href='ABAIT_remove_members_v2.php'>Return to Remove Members Form</a></h4>\n";
	}else{
		$header_title = "Member(s) Successfully Removed from ABAIT";
		print"<h2 class='m-3 p-2 footer_div' align='center'>$header_title</h2>";
	}
	...
	$header_title = "Remove Program Members";
    print"<h2 class='m-3 p-2 footer_div' align='center'>$header_title</h2>";
	...
	<h5 align='center'>Check all that apply</h5>
		...
		<form 	name='form'
				...
				action="ABAIT_remove_members_v2.php" 
				method="post">
		<?
